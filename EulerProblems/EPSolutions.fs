...
printfn "EP1-6 Time %fms" ts.Elapsed.TotalMilliseconds

ts.Restart()
ep7_10.solve_ep7 |> printfn "%d"
printfn "EP7 Time %fms" ts.Elapsed.TotalMilliseconds
ts.Restart()
...
printfn "EP10 Time %fms" ts.Elapsed.TotalMilliseconds
ts.Restart()
...
printfn "EP14.1 Time %fms" ts.Elapsed.TotalMilliseconds
ts.Restart()

ep14.solve2 |> printfn "%d"
printfn "EP14.2 Time %fms" ts.Elapsed.TotalMilliseconds
ts.Restart()
...
ep35.solve 1000000 |> printfn "%d"

ep36.solve 999999 |> printfn "%d"

printfn "Total time %fs" ts.Elapsed.TotalSeconds
ts.Reset()
